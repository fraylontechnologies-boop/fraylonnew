...
const ServicePage: React.FC<ServicePageProps> = ({
  ...
  // const displayExpertise = ourExpertise || features || [];
  const displayServices = servicesOffered || services || [];
  const displayHowHelp = howCanWeHelp || industries || [];
  return (
        ...
        <Container>
          <div
            ...
            style={!showHeroForm ? {
              ...
              maxWidth: heroLayout === 'centered' ? '900px' : '100%',
              margin: heroLayout === 'centered' ? '0 auto' : '0',
              textAlign: (heroLayout === 'centered' ? 'center' : 'left') as 'center' | 'left'
            } : {}}
          >
            {/* Left Column - Content */}
            <div className={serviceStyles.heroContent} style={{ alignItems: heroLayout === 'centered' && !showHeroForm ? 'center' : 'flex-start' }}>
              <h1 style={{
                fontSize: '48px',
                fontWeight: '700',
                marginBottom: '30px',
                lineHeight: '1.2',
                color: 'var(--title)',
                textAlign: (heroLayout === 'centered' && !showHeroForm ? 'center' : 'left') as 'center' | 'left'
              }}>
                {title}
              </h1>
              <p style={{
              ...
              <div style={{ marginBottom: '40px', textAlign: (heroLayout === 'centered' && !showHeroForm ? 'center' : 'left') as 'center' | 'left' }}>
                <div className={styles.splitCta} style={{ justifyContent: heroLayout === 'centered' && !showHeroForm ? 'center' : 'flex-start' }}>
          ...
          <Container>
            <div style={{ maxWidth: '800px' }}>
              ...
              <p style={{
                ...
                We help businesses develop, deploy, and scale {title.toLowerCase()} solutions that enhance decision-making, automate workflows, and drive intelligent process optimization.
              </p>
              <h3 style={{
                fontSize: '20px',
                fontWeight: '600',
                ...
                Why Choose Fraylon Technologies?
              </h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {displayWhyUs.map((advantage, index) => {
                  // Split the advantage text to bold the main heading part
                  ...
                  return (
                    <li key={index} style={{
                      ...
                      <span>
                        <strong style={{ fontWeight: '700', color: 'var(--title)' }}>{mainHeading}</strong>
                        {description && (
                          <span style={{ color: 'var(--body)' }}> – {description}</span>
                        )}
                      </span>
                    </li>
                  );
        ...
        <Container>
          <div style={{ maxWidth: '800px' }}>
            ...
            <p style={{
              ...
              Organizations across various industries rely on {title.toLowerCase()} solutions to enhance operational efficiency, security, and data intelligence.
            </p>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              {displayHowHelp.slice(0, 4).map((industry, index) => (
                <li key={index} style={{
                  display: 'flex',
                  alignItems: 'flex-start',
                  marginBottom: '15px',
          ...
          <div style={{ maxWidth: '1200px' }}>
            ...
            <div style={{
              ...
              {deliverables && deliverables.map((deliverable, index) => {
                // Split the deliverable text to bold the main heading part
            ...
            <div style={{
              ...
              >
                ...
                {[...integrations, ...integrations, ...integrations]
                  .filter(integration => getToolIcon(integration) !== null)
